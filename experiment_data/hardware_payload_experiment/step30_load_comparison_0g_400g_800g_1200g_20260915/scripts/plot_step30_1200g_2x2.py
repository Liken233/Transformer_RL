...
PNG_PATH = RESULT_DIR / "step30_1200g_2x2.png"
PDF_PATH = RESULT_DIR / "step30_1200g_2x2.pdf"
...
fig.subplots_adjust(left=0.09, right=0.98, top=0.91, bottom=0.12,
                    wspace=0.25, hspace=0.48)
fig.suptitle("30-deg Step Response with 1200 g Load", fontsize=13)

ax = axes[0, 0]
ax.plot(view["time_s"], view["target_deg"], "k--", linewidth=1.5,
        label="Target")
ax.plot(view["time_s"], view["link_deg"], color="#165DFF",
        linewidth=1.5, label="Link angle")
...
ax = axes[1, 0]
ax.plot(view["time_s"], view["policy_output_numeric"],
        color="#D94E5D", linewidth=1.2)
...
ax.plot(period_time, period_ms, color="#7A52C7", linewidth=1.0,
        marker="o", markersize=2.5)
ax.axhline(1.0, color="0.15", linestyle="--", linewidth=1.1,
