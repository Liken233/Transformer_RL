...
from extractor.CNNExtractor import CNNExtractor, SeqFeaturesExtractor


class CNNActorCriticPolicy(ActorCriticPolicy):
    """
    Actor 用 1D-CNN，Critic 用标准 MLP。
    ...
    def _build_mlp_extractor(self) -> None:
        ...
        """
        # Actor: CNN
        self.mlp_extractor = CNNExtractor(**self.cnn_kwargs)
