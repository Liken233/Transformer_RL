...
from extractor.TransformerExtractor import TransformerExtractor,SeqFeaturesExtractor

class TransformerActorCriticPolicy(ActorCriticPolicy):
    """
    Actor 用 Transformer，Critic 用标准 MLP。
    ...
    def _build_mlp_extractor(self) -> None:
        ...
        """
        # Actor: Transformer
        self.mlp_extractor = TransformerExtractor(**self.transformer_kwargs)
