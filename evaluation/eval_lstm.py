...
"""
================================================================================
LSTMPPO 模型评估与 MATLAB 同步工具
================================================================================
兼容 LSTMActorCriticPolicy，支持 VecFrameStack 堆叠观测。
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='LSTMPPO 模型评估与 MATLAB 同步工具',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
示例:
  评估模式:
    python eval_lstm.py --mode evaluate --model_path model.zip \
        --stack_frames 8 --feature_dim 5 --episodes 5

  同步模式:
    python eval_lstm.py --mode sync --model_path model.zip \
        --stack_frames 8 --feature_dim 5 --action_source model

  对比模式:
    python eval_lstm.py --mode compare --model_path model.zip \
        --stack_frames 8 --feature_dim 5
        """
    )
    ...
    parser.add_argument('--mode', type=str, default='evaluate',
                        ...
                        help='运行模式')
    parser.add_argument('--model_path', type=str, default='/home/y/vscode_ws/xuan/PPTransformer/experiments/20260720_114201_random_lstm_nenv30_len8/models/final_model.zip',
                        help='PPO 模型路径 (.zip)')
...
class MATLABSyncClient:
    """MATLAB UDP 同步客户端，支持 LSTMPPO 模型控制"""
