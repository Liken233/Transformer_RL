...
"""
================================================================================
CNNPPO 模型评估与 MATLAB 同步工具
================================================================================
兼容 CNNActorCriticPolicy，支持 VecFrameStack 堆叠观测。
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='CNNPPO 模型评估与 MATLAB 同步工具',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
示例:
  评估模式:
    python eval_cnn.py --mode evaluate --model_path model.zip \
        --stack_frames 8 --feature_dim 5 --episodes 5

  同步模式:
    python eval_cnn.py --mode sync --model_path model.zip \
        --stack_frames 8 --feature_dim 5 --action_source model

  对比模式:
    python eval_cnn.py --mode compare --model_path model.zip \
        --stack_frames 8 --feature_dim 5
        """
    )
...
class MATLABSyncClient:
    """MATLAB UDP 同步客户端，支持 CNNPPO 模型控制"""
